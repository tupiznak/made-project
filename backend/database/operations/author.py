...
try:
    import backend.database.db_objects.author as db
    from backend.database.connection import citations_db
    from backend.database.models.author import Author, HistoryObject
    from backend.database.operations.paper import PaperOperations
